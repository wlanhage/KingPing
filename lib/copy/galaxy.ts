...
export const galaxyStreakTemplates: Record<string, string[]> = {
  ...
  FIRST_WIN: [
    ...
    '🐸 Gör, eller gör inte. @{winner} gjorde. Första vinsten.',
    '🎲 Säg aldrig oddsen. @{winner} vann ändå — för första gången.',
  ],
  COMEBACK: [
    ...
    '📡 "Hjälp mig, @{winner}, du är mitt enda hopp." Efter {days} dagar svarade @{winner}.',
  ],
  SAME_KING_STREAK_2: [
  ...
  SAME_KING_STREAK_3: [
    ...
    '✨ Kraften är stark i denna. Tre raka för @{winner}.',
  ],
  SAME_KING_STREAK_4: [
  ...
  SAME_KING_STREAK_5_PLUS: [
    ...
    '🔴 Order 66 verkställd. @{winner} har rensat rådet — fem raka.',
  ],
  STREAK_BREAK_SMALL: [
    ...
    '🌌 @{winner} kände en störning i kraften och avbröt @{previousKing}s två raka.',
  ],
  STREAK_BREAK_MEDIUM: [
    ...
    '🖤 "Jag är din far." @{winner} tog kronan från @{previousKing} efter tre raka. NEJ!',
  ],
  STREAK_BREAK_MAJOR: [
    ...
    '⚔️ "Det är över, @{previousKing}! Jag har höjdfördelen!" @{winner} bröt {previousStreakCount} raka.',
  ],
  STREAK_BREAK_LEGENDARY: [
    ...
    '🌋 Du var den utvalde, @{previousKing}! @{winner} lämnar dig vid lavan efter {previousStreakCount} raka.',
  ],
};
