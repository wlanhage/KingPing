...
export const BADGES = [
  ...
  { id: 'jar_jar', name: 'Jar Jar Binks', emoji: '🦎', description: 'Den ende utan vinst — eller, när alla vunnit, den med minst tid på tronen. Meesa så ledsen.', rarity: 'epic', category: 'shame', tone: 'roast' },
