...
export const BADGES = [
  ...
  { id: 'emperor', name: 'Kejsaren', emoji: '👑', description: 'Mest total tid på tronen all-time.', rarity: 'legendary', category: 'throne', tone: 'prestige', comparative: true },
  { id: 'crown_collector', name: 'Kronsamlaren', emoji: '💎', description: 'Flest totala vinster.', rarity: 'epic', category: 'throne', tone: 'prestige', comparative: true },
  { id: 'efficient_monarch', name: 'Effektiv monark', emoji: '🎯', description: 'Högst tron-tid per vinst.', rarity: 'epic', category: 'meta', tone: 'prestige', comparative: true },
  { id: 'longest_reign', name: 'Historieboken', emoji: '📜', description: 'Har haft den längsta enskilda regeringstiden.', rarity: 'legendary', category: 'legacy', tone: 'prestige', comparative: true },
  ...
  { id: 'friday_champion', name: 'Fredagsmästaren', emoji: '🏟️', description: 'Flest fredagsvinster i riket.', rarity: 'epic', category: 'friday', tone: 'prestige', comparative: true },
  ...
  { id: 'recent_champion', name: 'Nylig mästare', emoji: '📈', description: 'Flest vinster senaste 30 dagarna.', rarity: 'epic', category: 'form', tone: 'prestige', comparative: true },
  { id: 'steep_curve', name: 'Hög utvecklingskurva', emoji: '🧗', description: 'Störst procentuell ökning av vinster jämfört med förra säsongen.', rarity: 'epic', category: 'form', tone: 'prestige', comparative: true },
  ...
  { id: 'historically_relevant', name: 'Historiskt relevant', emoji: '🪦', description: 'Toppspelare historiskt, men svag nutida form.', rarity: 'epic', category: 'legacy', tone: 'roast', ladder: 'inactivity', tier: 4, comparative: true },
  ...
  { id: 'regime_changer', name: 'Regimskiftare', emoji: '🩸', description: 'Har brutit flest streaks.', rarity: 'epic', category: 'combat', tone: 'dramatic', comparative: true },
  { id: 'king_slayer', name: 'Kungamördaren', emoji: '🪓', description: 'Har störtat de längsta regeringarna — mest trontid tagen från andra.', rarity: 'epic', category: 'combat', tone: 'dramatic', comparative: true },
  ...
  // Arv, meta och strid.
  { id: 'season_opener', name: 'Rikets förste', emoji: '🎬', description: 'Tog säsongens allra första krona.', rarity: 'epic', category: 'legacy', tone: 'prestige', comparative: true },
  { id: 'jar_jar', name: 'Jar Jar Binks', emoji: '🦎', icon: '/badges/jar-jar.png', description: 'Exsqueeze me! Meesa trodde det var meesa tur nu. How wude!', rarity: 'epic', category: 'shame', tone: 'roast', comparative: true },
  { id: 'eternal_second', name: 'Den evige tvåan', emoji: '🥈', description: 'Näst mest trontid. Så nära, så länge.', rarity: 'rare', category: 'shame', tone: 'roast', comparative: true },
