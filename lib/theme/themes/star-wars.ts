...
export const starWars: Theme = {
  ...
  seasonWord: 'Episod',
  nationLabel: 'Galaxens läge',
  nationStates: {
    STABLE_ERA: { name: 'Republiken', emoji: '🏛️', blurb: 'Senaten sammanträder i lugn och ro. Ingen har utmanat på allvar.' },
    TENSION: { name: 'Separatisterna rör på sig', emoji: '⚠️', blurb: 'Flera har smakat på tronen den senaste tiden. Oro i yttre randen.' },
    INSTABILITY: { name: 'Klonkrigen', emoji: '⚔️', blurb: 'Tronen byter händer oftare än droiderna byter batteri.' },
    DYNASTY: { name: 'Imperiet reser sig', emoji: '🌑', blurb: 'Tre raka eller fler. Skuggan över galaxen växer.' },
    TYRANNY: { name: 'Imperiet', emoji: '🛰️', blurb: 'Fem raka eller fler. Rebellerna har gått under jorden.' },
    REVOLUTION: { name: 'Rebellalliansen', emoji: '🔥', blurb: 'Ett imperium har just fallit. Ett nytt hopp.' },
  },
  progressTemplate: '{left} {unit} kvar, du har.',
  profile: {
    addTitle: 'Rekrytera en ny jedi',
    addSubtitle: 'Lägg till en ny spelare i galaxen.',
    addPlaceholder: 'Namnge en ny jedi…',
    addButton: 'Rekrytera',
    addBusy: 'Rekryterar…',
    addDuplicate: 'En jedi med det namnet finns redan.',
    viewProfile: 'Visa profil →',
    back: '← Tillbaka till jediriddarna',
    ...
    quoteNever: 'Denna jedi väntar fortfarande på sin första krona.',
    rankTitle: 'Galaxens rang',
    rankSubtitle: 'Var spelaren står mot alla andra i galaxen.',
    rankTop: ['Bäst i galaxen', 'Tvåa i galaxen', 'Trea i galaxen'],
    timelineTitle: 'Holokronen',
    timelineSubtitle: 'Spelarens väg genom galaxen, senaste först.',
    timelineEmpty: 'Ingen historik ännu — holokronen väntar på sin första inspelning.',
    events: {
      NEW_KING: 'Ny mästare upphöjd', FIRST_WIN: 'Första vinsten', SAME_KING_STREAK_2: 'Försvarade tronrummet (x2)', SAME_KING_STREAK_3: 'Orden byggs (x3)',
      SAME_KING_STREAK_4: 'Järngrepp (x4)', SAME_KING_STREAK_5_PLUS: 'Imperiet (x5+)', STREAK_BREAK_SMALL: 'Bröt en liten streak', STREAK_BREAK_MEDIUM: 'Bröt en streak',
      STREAK_BREAK_MAJOR: 'Störtade en orden', STREAK_BREAK_LEGENDARY: 'Legendariskt störtande', COMEBACK: 'Återkomst', FRIDAY_FINAL: 'Fredagsduell', RECORD_BROKEN: 'Rekord slaget',
    },
    feudTitle: '⚔️ Rivalen i kraften',
    feudEmpty: 'Ingen rival ännu. Byt kronan fram och tillbaka med någon så uppstår en fejd i kraften.',
    feudTaken: 'kronor du snott',
    feudLost: 'kronor snodda från dig',
    feudLead: 'Övertaget är ditt — för nu.',
    feudBehind: 'Rivalen har övertaget. Hämnden är den mörka sidans väg.',
    feudTie: 'Dödläge. Varje krona är en duell.',
  },
  backdrop: 'starfield',
  historyStyle: 'crawl',
  heraldry: {
